...
PROGRAMS = [
    ...
    (2, "BNIの規定（ゲームのルール）、PALMSレポート、メンバー覚悟ライト"),
    (3, "権威シート、スビ-カ-ロ-テーション、チャプター"),
    (4, "出席、代理出席プログラム"),
    (5, "リファラルとリード合遣い、CEU（チャプター…）"),
    (6, "1to1のマナー・マナー、GAINSシート合遣い"),
    (7, "チャップツール：BNIネクトのプロフィール…"),
    (8, "ゴールドクラブ・メンバー、ビジターの招待、ビジ…"),
    (9, "ビジター-ホスト1日 自園体験"),
    (10, "トレーニングよよびイベントのカレンダー、オン…"),
]
